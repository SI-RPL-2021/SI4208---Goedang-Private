          ...
          <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <h1 class="mt-4">Sabun bayi</h1>
                    <br>
                    <div class="row row-cols-1 row-cols-md-5 g-6">
                        <div class="col">
                          <div class="card">
                            <img src="bayi aveeno.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Sabun Bayi Aveeno Relief Creamy Wash 236ml</h5>
                              <p class="card-text">Rp.268.500</p>
                            </div>
                          </div>
                        </div>
                        <div class="col">
                          <div class="card">
                            <img src="bayi cetaphil.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Cetaphil Baby Gentle Wash & Shampoo 230ml</h5>
                              <p class="card-text">Rp.89.500</p>
                            </div>
                          </div>
                        </div>
                        <div class="col">
                          <div class="card">
                            <img src="bayi sebamed.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Sebamed Baby Bubble Bath 200ml</h5>
                        ...
                        <div class="col">
                          <div class="card">
                            <img src="bayi zwitsal.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Zwitsal Baby Bath Hair & Body 450ml</h5>
                              <p class="card-text">Rp.32.200</p>
                            </div>
                          </div>
                        </div>
                      </div>

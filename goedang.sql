...
--
-- Host: 127.0.0.1
-- Generation Time: May 28, 2021 at 07:30 AM
...
(3, 'Oreo Original 133g', 175000, 'PT Kraft Indonesia', 1, 4, 50, 1, 133, '1 Dus (24pcs)', 'Kue kering cokelat berisi krim vanila.', ''),
(4, 'Oreo Chocolate Creme 133g', 175000, 'PT Kraft Indonesia', 1, 4, 50, 1, 133, '1 Dus (24pcs)', 'Kue kering cokelat berisi krim cokelat.', ''),
(5, 'Oreo Strawberry Creme133g', 175000, 'PT Kraft Indonesia', 1, 4, 50, 1, 133, '1 Dus (24pcs)', 'Kue kering cokelat berisi krim stroberi.', ''),
(6, 'Oreo Ice Cream 133g', 180000, 'PT Kraft Indonesia', 1, 4, 50, 1, 133, '1 Dus (24pcs)', 'Kue kering cokelat berisi krim blueberry dengan sensasi dingin.', ''),
(7, 'Oreo Peanut Butter and Chocolate 133g', 175000, 'PT Kraft Indonesia', 1, 4, 50, 1, 133, '1 Dus (24pcs)', 'Kue kering cokelat berisi krim selai kacang dan cokelat.', ''),
(8, 'Oreo Double Stuf 133g', 180000, 'PT Kraft Indonesia', 1, 4, 50, 1, 133, '1 Dus (24pcs)', 'Kue kering cokelat berisi krim vanila yang lebih tebal.', ''),
(9, 'Oreo Red Velvet 133g', 185000, 'PT Kraft Indonesia', 1, 4, 25, 1, 133, '1 Dus (24pcs)', 'Kue kering red velvet berisi krim vanila.', ''),
(10, 'Oreo Golden 133g', 180000, 'PT Kraft Indonesia', 1, 4, 35, 1, 133, '1 Dus (24pcs)', 'Kue kering keemasan berisi krim vanila.', ''),
...
(18, 16, 'gtpd.jpg', '2021-05-28 06:48:42'),
...
(35, 7, 'Kesehatan Bayi', ''),
(42, 9, 'Perlengkapan Kebersihan', ''),
(43, 9, 'Perlengkapan Mencuci', ''),
(44, 9, 'Produk Tisu', ''),
(45, 9, 'Pembasmi Serangga', ''),
(46, 9, 'Baterai', ''),
...
--
ALTER TABLE `kategori`
  MODIFY `id_kat` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `produk`
--
ALTER TABLE `produk`
  MODIFY `id_produk` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT for table `produk_img`
--
ALTER TABLE `produk_img`
  MODIFY `id_img` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `subkategori`
--
ALTER TABLE `subkategori`
  MODIFY `id_subkat` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;

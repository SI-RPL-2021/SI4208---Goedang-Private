            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row row-cols-1 row-cols-md-5 g-6">
                        ...
                        <div class="col">
                          <div class="card">
                            <img src="sampo sebamed.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Sebamed baby Children Shampoo</h5>
                        ...
                        <div class="col">
                          <div class="card">
                            <img src="sampo pigeon.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Pigeon Baby Shampoo 200ml</h5>
                              <p class="card-text">Rp.25.600</p>
                            </div>
                          </div>
                        </div>
                        <div class="col">

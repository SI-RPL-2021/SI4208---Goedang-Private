        ...
        <div class="elementisi">
            <div class="boxcontainerisi">
                <table class="isitable">
                    ...
                    <!--Baris 1-->
                    <tr>
                        <td class="hp"><img src="hp.svg" alt="Telp"></td>
                        <td class="isi">01423 556043</td>
                        <td><input type="text" placeholder="Email" class="nama"></td>
                    </tr>
                    
                    <!--Baris 2-->
                    <tr>
                        <td class="email"><img src="email.svg" alt="Email"></td>
                        <td class="isi">goedang@gmail.com</td>
                        <td><input type="text" placeholder="Nomor Telephone" class="nama"></td>
                    </tr>

                    <!--Baris 3-->
                    <tr>
                        <td class="ig"><img class="ig" width="20px" src="ig.png" alt="Instagram"></td>
                        <td class="isi">@infogoedang</td>
                        <td rowspan="3"><input type="text" placeholder="Isi Pesan" class="pesan" ></td>
                    </tr>

                    <!--Baris 4-->
                    <tr>
                        <td class="loc"><img src="location.svg" alt="location"></td>
                        <td class="isi">Jalan Liwan no.18. Jakarta</td>
                    </tr>

                    <!--Baris 5-->
                    <tr>
                        <td class="jadwal"><img src="jadwal.svg" alt="Jam"></td>
                        <td class="isi">08.00 - 21.00</td>
                    </tr>

...
session_start();
  ...
  if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
    ...
    $datapoint= mysqli_query($link, "SELECT * FROM pesanan WHERE id_user='".$_SESSION["loggedin"]."'");
    $point = mysqli_fetch_assoc($datapoint);
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-5" >
            ...
            <?php while ($point = mysqli_fetch_assoc($datapoint)){

                $bonus = $point["total"]*10/100;
            ...
            ?>
                ...
                <div class ="row" style="" >
                  <div class="col-sm" style="text-align: left; margin-left: 5% ; ">
                    <p style=”text-align:justify;”>
                      ...
                      <h5 class="card-title">Point Belanja Rp.<?php echo $point["total"] ?> </h5>
                      <small class="card-text"><?php echo $point["tgl_order"] ?></small>
                      </p>
                  </div>
                  <div class="col-sm" style="text-align: right;margin-right: 5%; padding-top: 30px;">
                    <h5>+<?php echo $bonus?></h5>
                  </div>
                </div>
                <?php }; ?>
                ...
                <div class ="row" style="" >
                  ...
                  <div class="col-sm" style="text-align: right;margin-right: 5%; padding-top: 30px;">
                    <h5><?php  $tot_bayar = 0;echo $tot_bayar += $bonus; ?></h5>
                  </div>
                </div>

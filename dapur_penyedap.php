          ...
          <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <h1 class="mt-4">Penyedap Rasa</h1>
                    <br>
                    <div class="row row-cols-1 row-cols-md-5 g-6">
                        <div class="col">
                          <div class="card">
                            <img src="penyedap masako.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Masako Rasa Ayam 250g</h5>
                              <p class="card-text">Rp.9.400</p>
                            </div>
                          </div>
                        </div>
                        <div class="col">
                          <div class="card">
                            <img src="penyedap royco.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Royco Rasa Ayam 8g x 12pcs</h5>
                              <p class="card-text">Rp.5.050</p>
                            </div>
                          </div>
                        </div>
                        <div class="col">
                          <div class="card">
                            <img src="penyedap sasa.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Penyedap Rasa Sasa 1000g</h5>
                              <p class="card-text">Rp.31.800</p>
                            </div>
                          </div>
                        </div>
                        <div class="col">
                          <div class="card">
                            <img src="penyedap knorr.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Penyedap Rasa Knorr 1000g</h5>
                              <p class="card-text">Rp.85.800</p>
                            </div>
                          </div>
                        </div>
                      </div>

...
if(isset($_POST['tambah_cabang'])){
    if (!empty($_POST["alamatGudang"])){
    $alamat = $_POST["alamatGudang"];
    $email = $_POST["email"];
    $telephone = $_POST["nomorTelephone"];
    $instagram = $_POST["akuInstagram"];
    $buka = $_POST["jamBuka"];
    $tutup = $_POST["jamTutup"];

    $sql = "INSERT INTO cabang_gudang ( alamat, email, no_hp, akun_instagram, jam_buka, jam_tutup) VALUES ('$alamat', '$email', '$telephone','$instagram','$buka','$tutup')";
    ...
    echo "<script>alert('Oops, Data Alamat Belum Diisi ! ');</script>";
    echo "<script>location='tambah_cabang.php';</script>";
}
}
...
<html lang="en">
    <head>
        ...
        <title>Tambah Cabang Gudang| Admin Goedang</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-5">
                        <h1 class="mt-4">Tambah Informasi Gudang </h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="data_cabang.php">Data Cabang</a></li>
                            <li class="breadcrumb-item active">Tambah Tambah Informasi Gudang</li>
                        </ol>
                        <div class="card mb-4">
                                ...
                                <form class="p-3" action="" method="POST" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="alamatGudang" placeholder="Alamat Gudang" value="">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="nomorTelephone" placeholder="nomor telephone" value="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group mb-4">
                                                <label for="stok">Akun Instagram</label>
                                                    <input type="text" class="form-control" placeholder="akun Instagram" name="akuInstagram" value="">
                                            </div>
                                        </div>
                                        <div class="col">
                                    ...
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                        <button type="submit" class="btn btn-primary" name="tambah_cabang">Tambah Baru</button>
                                    </div>
                                </form>
                            </div>
                        </div>

...
<div class="container">
  ...
  <button type="button" a href='#' class="btn btn-primary">Beli</button>
    ...
    <br><br>
      ...
      <h6>Stok &nbsp; &nbsp; &nbsp; &nbsp; 27295<h6>
      <br>
      <h6>Vendor &nbsp; &nbsp; PT. Mondelez Indonesia Manufacturing<h6>
      <br>
      <h6>Satuan<h6>
      <br>
      <button type="button" class="btn btn-light">/pcs</button>
      <button type="button" class="btn btn-light">/box (isi 24 pcs)</button>
      <h6>Varian<h6>
      <br>
      <button type="button" class="btn btn-light">original</button>
      <button type="button" class="btn btn-light">double stuff</button>
      <button type="button" class="btn btn-light">chocholate creme</button>
      <button type="button" class="btn btn-light">dark and white chocholate</button>
      <button type="button" class="btn btn-light">peanut butter and chocholate</button>
      <button type="button" class="btn btn-light">strawberry creme</button>
      <button type="button" class="btn btn-light">ice cream blueberry flavor</button>
      <button type="button" class="btn btn-light">red velvet</button>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/oreo1.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="img/oreo2.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="img/oreo3.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="img/oreo4.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="img/oreo5.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="img/oreo6.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="img/oreo7.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="img/oreo8.jpg" class="d-block w-100" alt="...">
    </div>
  </div>

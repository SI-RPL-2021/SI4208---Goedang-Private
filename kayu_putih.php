          ...
          <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <h1 class="mt-4">Minyak Kayu Putih</h1>
                    <br>
                    <div class="row row-cols-1 row-cols-md-5 g-6">
                        <div class="col">
                          <div class="card">
                            <img src="kayuputih caplang.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Minyak Kayu Putih Cap Lang 210ml</h5>
                              <p class="card-text">Rp63.900</p>
                            </div>
                          </div>
                        </div>
                        <div class="col">
                          <div class="card">
                            <img src="kayuputih capayam.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Minyak Kayu Putih Cap Ayam 40ml</h5>
                        ...
                        <div class="col">
                          <div class="card">
                            <img src="kayuputih capgajah.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Minyak Kayu Putih Cap Gajah 120ml</h5>
                              <p class="card-text">Rp.37.100</p>
                            </div>
                          </div>
                        </div>
                        <div class="col">
                          <div class="card">
                            <img src="kayuputih konicare.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Minyak Kayu Putih Konicare 100ml</h5>

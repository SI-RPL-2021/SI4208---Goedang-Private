<?php
    ...
    if( isset($_POST['edit'])){
        ...
        if (!empty(array_filter($_FILES['img_produk']['name']))) {
            ...
            foreach($_FILES['img_produk']['name'] as $idd=>$val){
                // Get files upload path
                $fileName        = $_FILES['img_produk']['name'][$idd];
                $tempLocation    = $_FILES['img_produk']['tmp_name'][$idd];
    ...
    if(isset($_POST['delYes'])){
        mysqli_query($link, "DELETE FROM produk_img WHERE id_produk=$id");
        $cek = mysqli_affected_rows($link);
    ...
    $selectimg = mysqli_query($link, "SELECT images FROM produk_img WHERE id_produk='".$id."'");
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-group mb-3">
                                                ...
                                                <input class="form-control" type="file" id="img_produk[]" name="img_produk[]" multiple value="">
                                            </div>
                                        </div>
                                    </div>

          ...
          <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <h1 class="mt-4">Kacang</h1>
                    <br>
                    <div class="row row-cols-1 row-cols-md-5 g-6">
                        <div class="col">
                          <div class="card">
                            <img src="kacang telur garuda 250g.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Kacang Telur Garuda 250g</h5>
                              <p class="card-text">Rp.14.900/pcs</p>
                            </div>
                          </div>
                        </div>
                        <div class="col">
                          <div class="card">
                            <img src="kacang sukro.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Kacang Sukro 180g</h5>
                              <p class="card-text">Rp.10.000/pcs</p>
                            </div>
                          </div>
                        </div>
                        <div class="col">
                          <div class="card">
                            <img src="kacang mayasi.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Kacang Mayasi</h5>
                        ...
                        <div class="col">
                          <div class="card">
                            <img src="kacang ayam telor khas makassar 900g.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">kacang ayam telor khas makassar 900g</h5>
                              <p class="card-text">Rp.50.000/pcs</p>
                            </div>
                          </div>
                        </div>
                      </div>

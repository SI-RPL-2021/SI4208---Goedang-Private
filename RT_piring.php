          ...
          <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <h1 class="mt-4">Piring</h1>
                    <br>
                    <div class="row row-cols-1 row-cols-md-5 g-6">
                        <div class="col">
                          <div class="card">
                            <img src="piring lazada.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Piring Keramik Bulat Padang Warna Putih 3pcs </h5>
                        ...
                        <div class="col">
                          <div class="card">
                            <img src="piring coklat.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Piring Makan Motif Pinggir Coklat</h5>
                              <p class="card-text">Rp.7.000/pcs</p>
                            </div>
                          </div>
                        </div>
                        <div class="col">
                          <div class="card">
                            <img src="piring persegi.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Piring Persegi Krischef 25cm</h5>
                              <p class="card-text">Rp.49.410</p>
                            </div>
                          </div>
                        </div>
                        <div class="col">
                          <div class="card">
                            <img src="piring mawar.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Piring Makan Motif Mawar</h5>

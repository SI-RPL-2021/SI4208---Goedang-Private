          ...
          <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <h1 class="mt-4">Minyak Goreng</h1>
                    <br>
                    <div class="row row-cols-1 row-cols-md-5 g-6">
                        <div class="col">
                          <div class="card">
                            <img src="minyak bimoli.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                        ...
                        <div class="col">
                          <div class="card">
                            <img src="minyak filma.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Minyak Filma 2L</h5>
                              <p class="card-text">Rp.28.500</p>
                            </div>
                          </div>
                        </div>
                        <div class="col">
                          <div class="card">
                            <img src="minyak sunco.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Minyak Sunco 2L</h5>
                              <p class="card-text">Rp.29.300</p>
                            </div>
                          </div>
                        </div>
                        <div class="col">
                          <div class="card">
                            <img src="minyak tropical.jpeg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Minyak Tropical 2L</h5>
                              <p class="card-text">Rp.28.500</p>
                            </div>
                          </div>
                        </div>

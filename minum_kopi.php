          ...
          <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <h1 class="mt-4">Kopi</h1>
                    <br>
                    <div class="row row-cols-1 row-cols-md-5 g-6">
                        <div class="col">
                          <div class="card">
                            <img src="kopi kapal api.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Kopi Kapal Api Spesial 165g</h5>
                              <p class="card-text">Rp.13.200</p>
                            </div>
                          </div>
                        </div>
                        <div class="col">
                          <div class="card">
                            <img src="kopi gajah.png" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Kopi Tubruk Gajah 250g</h5>
                        ...
                        <div class="col">
                          <div class="card">
                            <img src="kopi nescafe.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Kopi Nescafe 200g</h5>
                        ...
                        <div class="col">
                          <div class="card">
                            <img src="kopi abc.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">ABC Kopi Susu Sachet isi 20</h5>
                              <p class="card-text">RP.17.340</p>
                            </div>
                          </div>
                        </div>
                      </div>

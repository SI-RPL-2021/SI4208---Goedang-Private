          ...
          <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <h1 class="mt-4">Gelas</h1>
                    <br>
                    <div class="row row-cols-1 row-cols-md-5 g-6">
                        <div class="col">
                          <div class="card">
                            <img src="gelas b.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Gelas B 20N 1Set 6pcs</h5>
                        ...
                        <div class="col">
                          <div class="card">
                            <img src="gelas bir.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Gelas Bir Kaca Bening 50cl</h5>
                              <p class="card-text">Rp.19.900</p>
                            </div>
                          </div>
                        </div>
                        <div class="col">
                          <div class="card">
                            <img src="gelas c.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Luminarc Coniques HB Tumbler Set Gelas Minum - Transparent 28cl 1Set 6pcs</h5>
                        ...
                        <div class="col">
                          <div class="card">
                            <img src="gelas whine.jpeg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">Gelas Whine White</h5>
                              <p class="card-text">Rp.41.900</p>
                            </div>
                          </div>
                        </div>
                      </div>

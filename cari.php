...
<!-- end navbar -->
    ...
    <?php $link = mysqli_connect("localhost", "root", "", "goedang");
      ...
      <hr/ class="garis">
        <section id="home">
            <img class="product" src="img/oreo1.jpg" alt="Product">
            <div class="kolom">
                <div class="deskripsi">
    ...
    $sql ="SELECT*FROM produk WHERE nama_produk LIKE '%$cari%'";
      ...
      while ($data = mysqli_fetch_assoc($result)):?>
        <section id="home">
            <img class="product" src="oreo1.jpg" alt="Product">
            <div class="kolom">
                <div class="deskripsi">
                    <h2><?php echo $data['nama_produk']; ?> </h2>
                    <br>
                    ...
                    <br>
                    <br>
                    <p><a href="detail.php?id=<?php echo $data["id_produk"]; ?>" class="tbl-detail">Detail</a></p>
                </div>
            </div>
        </section>
    </div>

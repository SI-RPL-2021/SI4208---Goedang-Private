          ...
          <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <h1 class="mt-4">HandSanitizer</h1>
                    <br>
                    <div class="row row-cols-1 row-cols-md-5 g-6">
                        <div class="col">
                          <div class="card">
                            <img src="handsanitizer antis.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">HandSanitizer Antis Spray Jeruk Nipis</h5>
                              <p class="card-text">Rp.10.900</p>
                            </div>
                          </div>
                        </div>
                        <div class="col">
                          <div class="card">
                            <img src="handsanitizer detol.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">HandSanitizer Detol</h5>
                              <p class="card-text">Rp.10.900</p>
                            </div>
                          </div>
                        </div>
                        <div class="col">
                          <div class="card">
                            <img src="handsanitizer eskulin.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">HandSanitizer Eskulin Kids</h5>
                        ...
                        <div class="col">
                          <div class="card">
                            <img src="handsanitizer klinsen.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">HandSanitizer Klinsen</h5>
                              <p class="card-text">Rp.11.900</p>
                            </div>
                          </div>
                        </div>
                      </div>
